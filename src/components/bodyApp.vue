...
<template>
        <main class = "
                        ...
                        text-white">
          <div class = "relative">
            <span class = "absolute font-bold text-xl left-16 -top-5 px-6 py-3 bg-[#0082f9]">
              CURRENT SERIES
            </span>
          </div>              
          <div class = "flex justify-center flex-wrap gap-y-8 pt-16">
            <singleCard v-for="comic in comics" :key = "comic.series"
          ...
          <div class = "flex justify-center items-center py-4">
            ...
            <button class = "px-4 py-2 bg-[#0082f9] rounded-xl">
              LOAD MORE
            </button>
